...
with st.spinner('Loading data from Bigquery'):
    df = pandas_gbq.read_gbq(sql_query, credentials=credentials, progress_bar_type=None, project_id="sol-eng-nickp")
